...
public class CardContentFragment extends Fragment {
    ...
    public static class ContentAdapter extends RecyclerView.Adapter<ViewHolder> {
        ...
        public ContentAdapter(Context context) {
            ...
            mExhibit = resources.getStringArray(R.array.exhibit_yarus2);
            mExhibitDesc = resources.getStringArray(R.array.yarys2_desc);
            TypedArray a = resources.obtainTypedArray(R.array.yarys2_picture);
