...
public class Exhibit4DetailActivity extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        String[] exhibit = resources.getStringArray(R.array.exhibit_vostok);
        collapsingToolbar.setTitle(exhibit[postion % exhibit.length]);

        String[] exhibitDetails = resources.getStringArray(R.array.details_zap);
        ...
        TypedArray exhibitPictures = resources.obtainTypedArray(R.array.vostok_picture);
