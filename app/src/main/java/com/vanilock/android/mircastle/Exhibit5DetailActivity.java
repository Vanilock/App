...
public class Exhibit5DetailActivity extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        String[] exhibit = resources.getStringArray(R.array.exhibit_centr);
        collapsingToolbar.setTitle(exhibit[postion % exhibit.length]);

        String[] exhibitDetails = resources.getStringArray(R.array.details_centr);
        ...
        TypedArray exhibitPictures = resources.obtainTypedArray(R.array.centr_picture);
