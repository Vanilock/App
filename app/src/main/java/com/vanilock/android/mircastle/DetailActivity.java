...
public class DetailActivity extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        String[] exhibit = resources.getStringArray(R.array.exhibit_yarus2);
        collapsingToolbar.setTitle(exhibit[postion % exhibit.length]);

        String[] exhibitDetails = resources.getStringArray(R.array.details_yarys2);
        ...
        TypedArray  exhibitPictures = resources.obtainTypedArray(R.array.yarys2_picture);
