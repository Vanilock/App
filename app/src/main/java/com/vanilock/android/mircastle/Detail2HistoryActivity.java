...
public class Detail2HistoryActivity extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_detail2_history);
        ...
        String[] exhibit = resources.getStringArray(R.array.vlad);
        collapsingToolbar.setTitle(exhibit[postion % exhibit.length]);

        String[] exhibitDetails = resources.getStringArray(R.array.vlad_details);
        ...
        TypedArray exhibitPictures = resources.obtainTypedArray(R.array.vlad_picture);
