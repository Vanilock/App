...
public class Exhibit2DetailActivity extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        String[] exhibit = resources.getStringArray(R.array.exhibit_yarus3);
        collapsingToolbar.setTitle(exhibit[postion % exhibit.length]);

        String[] exhibitDetails = resources.getStringArray(R.array.details_yarys3);
        ...
        TypedArray exhibitPictures = resources.obtainTypedArray(R.array.yarys3_picture);
