...
public class Exhibit6DetailActivity extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        String[] exhibit = resources.getStringArray(R.array.exhibit_ysyp);
        collapsingToolbar.setTitle(exhibit[postion % exhibit.length]);

        String[] exhibitDetails = resources.getStringArray(R.array.details_ysyp);
        ...
        TypedArray exhibitPictures = resources.obtainTypedArray(R.array.ysyp_picture);
